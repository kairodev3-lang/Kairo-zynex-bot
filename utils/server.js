...
const TELEGRAM_URL = 'https://t.me/kairo_chat';
const WHATSAPP_URL = 'https://whatsapp.com/channel/0029VbDmi1g77qVOA4cfRq13';
const SOUND_URL = 'https://files.catbox.moe/ialmg6.mp3';
...
<style>
:root{--bg:#05070d;--panel:rgba(12,18,32,.72);--line:rgba(255,255,255,.12);--text:#f8fbff;--muted:#98a7bd;--accent:#7c5cff;--accent2:#00d9ff;--good:#46e6a3;--danger:#ff5470}
...
body:before{width:300px;height:300px;background:#7c5cff;top:-90px;left:-90px}
body:after{width:320px;height:320px;background:#00d9ff;right:-130px;bottom:-120px;animation-delay:-4s}
